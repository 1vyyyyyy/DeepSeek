...
from Siam.nets.siamese import Siamese as siamese
from Siam.utils.utils import letterbox_image, preprocess_input, cvtColor, show_config
...
class Siamese(object):
    _defaults = {
        ...
        #-----------------------------------------------------#
        "model_path"        : 'C:/Users/Administrator/Desktop/Blockchain-backend/Siam/model_data/Omniglot_vgg.pth',
        #-----------------------------------------------------#
        #   输入图片的大小。
        #-----------------------------------------------------#
        "input_shape"       : [105, 105],
    ...
    def detect_image(self, image_1, image_2):
        ...
        #     for i in np.array(image_1, np.float32):
        #         f.write(str(i))
        with torch.no_grad():
            #---------------------------------------------------#
